...
| `/remove_limit <coin>` | `/lr` | Удалить все лимиты для монеты |
...
**Удаление лимитов:**
```
/remove_limit LSK — удалить все лимиты для LSK (общие и по ордерам)
/lr BTC           — удалить все лимиты для BTC (алиас)
```
